...
class App(tk.Tk):
    ...
    def __init__(self) -> None:
        ...
        self.btn_jog = ttk.Button(opt, text="Run Safe Jog (respects RPM limit)", command=self.on_jog)
        ...
        self.btn_run = ttk.Button(btns, text="Generate + Run Selected Mode", command=self.on_run)
